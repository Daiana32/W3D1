...
function crazySum(wholnum1, wholnum2) {

    console.log((wholnum1 === wholnum2) ? wholnum1+wholnum2 : (wholnum1+wholnum2) *3) ;
}
crazySum(45,20);
...
function boundary(wholenummer) {

   if((wholenummer >= 20 && wholenummer <= 100) ||  wholenummer === 400) {
   console.log(true);
   } else {
    console.log(false);
   }
...
/* ESERCIZIO 3
 ...
 ritorna invertita (es.: EPICODE => EDOCIPE).
*/
...
console.log(reverseString('DaianaElizabeth'));
...
function upperFirst(text) {
 let myNewString = text.charAt(0);
 let rest = text.slice(1);
 return myNewString.toUpperCase() + rest;
}
upperFirst('peponillo');
